package com.allen.androidalldemos.qrcode.tools;
...
public final class EncodingHandler {
    ...
    public static final Bitmap createQRCode(String str, int widthAndHeight) throws WriterException {
    ...
    public Bitmap createCode(String string, Bitmap mBitmap)
        ...
        BitMatrix matrix = writer.encode(string, BarcodeFormat.QR_CODE, 800, 800, hst);//生成二维码矩阵信息
