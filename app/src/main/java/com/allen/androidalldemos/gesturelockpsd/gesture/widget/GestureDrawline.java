package com.allen.androidalldemos.gesturelockpsd.gesture.widget;
...
import com.allen.androidalldemos.gesturelockpsd.gesture.common.Constants;
import com.allen.androidalldemos.gesturelockpsd.gesture.entity.GesturePoint;
...
public class GestureDrawline extends View {
	...
	public GestureDrawline(Context context, List<GesturePoint> list,
		...
		super(context);
		screenDispaly = DisplayUtil.getScreenDispaly(context);
